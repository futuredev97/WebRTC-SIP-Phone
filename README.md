...
```
$ openssl req -new -sha256 -nodes -out /home/csr/cert.csr -newkey rsa:2048 -keyout /home/certs/cert.key
```
Generate SSL V3 file:
```
$ nano /home/csr/openssl-v3.cnf
```
And populate with:
```
...
```
$ openssl x509 -req -in /home/csr/cert.csr -CA /home/ca/Root-CA.crt -CAkey /home/ca/Root-CA.key -CAcreateserial -out /home/certs/cert.crt -days 365 -sha256 -extfile /home/csr/openssl-v3.cnf
```
Generate PEM Combo Certificate:
```
$ cat /home/certs/cert.crt /home/certs/cert.key > /home/certs/cert.pem
```
Set Permission to Key:
```
$ chmod a+r /home/certs/cert.key
```
...
tlscertfile=/home/certs/cert.crt
tlsprivatekey=/home/certs/cert.key
enablestatic=yes
sessionlimit=1000
...
> You can test that this works by going to https://cert.local/httpstatus but in order to see this page, you have to download that Root CA certificate that you made earlier to your own PC. 
...
```
$ sudo cp /home/Browser-Phone/modules/ast-13/codec_opus_arm.so /usr/lib/asterisk/modules
or
$ sudo cp /home/Browser-Phone/modules/ast-16/codec_opus_arm.so /usr/lib/asterisk/modules
```
...
```
$ nano /home/asterisk-16.*.0/include/asterisk/buildopts.h
